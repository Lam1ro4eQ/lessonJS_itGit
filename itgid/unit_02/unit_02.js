...
let e1 = '3',
    f1 = 5;
document.querySelector('.out-4').textContent = e1 + f1; // e1 - строка, строка + число = строка
...
function t9() {
    ...
    let out9 = document.querySelector('.out-9').textContent = i9;
    document.querySelector('.i-9').value = ''; // добавил вновь начав изучать
}
...
function t10() {
    ...
    let out10 = document.querySelector('.out-10').textContent = i10 * 10;
}
...
function t11() {
    ...
    let out11 = document.querySelector('.out-11').textContent = i11 + 10;
}
...
function t12() {
    let name = document.querySelector('.i-12_1').value;
    let surname = document.querySelector('.i-12_2').value;
...
function t13() {
    let num1 = +document.querySelector('.i-13_1').value;
    let num2 = +document.querySelector('.i-13_2').value;
    document.querySelector('.out-13').textContent = num1 + num2;
}
...
document.querySelector('.i-16-1').type = 'number';
document.querySelector('.i-16-2').type = 'number';
function t16() {
    let num1 = +document.querySelector('.i-16-1').value;
    let num2 = +document.querySelector('.i-16-2').value;
    document.querySelector('.out-16').textContent = num1 + num2;
}
...
function t19() {
    ...
    num1 = parseInt(num1);
    num2 = parseInt(num2);
    document.querySelector('.out-19').textContent = num1 + num2;
}
...
function t20() {
    let name = document.querySelector('.i-20-1').value,
        surname = document.querySelector('.i-20-2').value,
        age = document.querySelector('.i-20-3').value,
        employ = document.querySelector('.i-20-4').value;
    document.querySelector('.out-20').textContent = 'Уважаемый ' + name + ', ' + surname + ', ' + 'ваш возраст ' + age + ', ' + 'по профессии вы ' + employ;
}
