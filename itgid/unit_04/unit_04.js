...
function f4() {
    let chBox = document.querySelector('.i-4').checked;
    document.querySelector('.out-4').textContent = chBox;
}
...
function f5() {
    let chBox = document.querySelector('.i-5');
    if (chBox.checked) {
        document.querySelector('.out-5').textContent = chBox.value;
    } else {
        document.querySelector('.out-5').textContent = chBox.checked;
    }
}
...
function f6() {
    ...
    document.querySelector('.out-6').textContent = i6.value;
}
...
function f7() {
    ...
    document.querySelector('.out-71').textContent = i7.value;
...
function f8() {
    ...
    //
    document.querySelector('.out-8').innerHTML = `<input class="i-81" type="text">
    <button class="button-primary b-81">Task-8.1</button>`;
     
    function f81 () {
        let inVal = document.querySelector('.i-81').value;
        document.querySelector('.out-81').textContent = inVal;
    }
...
function f9() {
    let radChec = document.querySelector('.r-9');
    if (radChec.checked) {
        document.querySelector('.out-9').textContent = radChec.value;
    } else {
...
function f10() {
    let inColor = document.querySelector('.i-10').value;
    document.querySelector('.out-10').style.background = inColor;
}
...
function f11() {
    let inColor = document.querySelector('.i-111').value,
        inColor2 = document.querySelector('.i-112').value;
    inColor2 = inColor;
...
function f12() {
    let dt = document.querySelector('.i-12').value;
    document.querySelector('.out-12').textContent = dt;
}
...
function f13() {
    let rIn = document.querySelector('.i-13').value;
    document.querySelector('.out-13').textContent = rIn;
}
...
function f14() {
    let area = document.querySelector('.t-14').value;
    document.querySelector('.out-14').textContent = area;
}
...
function f15() {
    let in15 = document.querySelector('.i-15').value;
    document.querySelector('.t-15').textContent = in15;
    document.querySelector('.out-15').textContent = in15;
}
...
function f16() {
    ...
    document.querySelector('.out-16').textContent = s16.value;
}
...
function f17() {
    ...
    document.querySelector('.out-17').textContent = s17.value;
}
...
function f18() {
    ...
    document.querySelector('.i-18').value = s18.value;
}
...
function f19() {
    let text = document.querySelector('.i-191').value,
        pas = document.querySelector('.i-192').value;
    document.querySelector('.out-19').textContent = `${text} ${pas}`;
}
...
function f20(e) {
    ...
    document.querySelector('.out-20').textContent = `${text} ${pass}`;
}
