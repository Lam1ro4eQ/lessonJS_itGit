...
// function t8() {
//    let a8_res = a8.filter( (elem, index) => {
...
//     })
//     console.log(a14map)
//     if (a14map.includes(a14_sym.toLowerCase())) {
//         return true; 
//     } else {
//         return false
//     }
