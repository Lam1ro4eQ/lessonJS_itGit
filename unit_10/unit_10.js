...
function f4() {
    out4.innerHTML = `${ar4[0]} - нулевой элемент<br> ${ar4[3]} - третий элемент<br> ${ar4[8]} - восьмой элемент<br>`;
...
function f17() {
    ...
    document.querySelector('.out-17').textContent = counter;
}
...
function f19() {
    ...
    document.querySelector('.out-19').textContent = minIn;
}
