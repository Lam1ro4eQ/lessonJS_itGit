...
function f8() {
    let ard8 = [];
    ard8[0] = document.querySelector('.i-8').value;
    for (let i = 0; i < d8.length; i++) {
        ard8[ard8.length] = d8[i];
    }
    d8 = ard8;
    showArr('.out-8', d8);
}
...
function f11() {
    let out = d11.indexOf(+document.querySelector('.i-11').value);
...
function f12() {
    let out = '';
    let char = +document.querySelector('.i-12').value;
...
function f14() {
    let in14 = +document.querySelector('.i-14').value;
    for ( let i = 1; i <= in14; i++) {
        d14.push(1);
    }
    showArr('.out-14', d14);
}
