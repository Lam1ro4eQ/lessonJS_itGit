...
let divMult = document.getElementById('two');
divMult.innerHTML = 12 * 12;

// Task 8.
// Создайте div с классом one. С помощью document.querySelector запишите в данный элемент текст 'Hello World'.

let clOne = document.querySelector('.one');
clOne.innerHTML = 'Hello World';
...
let aloneSpan = document.querySelector('span');
aloneSpan.innerHTML = 'world';
...
divFour.innerHTML = '<h4>произвольный текст</h4>';
divFour.innerHTML += '<p>параграф p с произвольным текстом</p>';      
...
let y1 = 6,
    y2 = 3;
document.querySelector('.self').innerHTML = y1 / y2;
