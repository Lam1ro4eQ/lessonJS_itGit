...
function f3(){
    let i31 = +document.querySelector('.i-31').value,
        i32 = +document.querySelector('.i-32').value;
    if (i31 > i32) {
...
function f5(){
    let symbol = +document.querySelector('.i-5').value;
    if (symbol > 0) {
...
function f6(){
    let symbol = +document.querySelector('.i-6').value;
    if (symbol % 2) {
...
function f7(){
    let i71 = document.querySelector('.i-71').value,
        i72 = document.querySelector('.i-72').value;
    document.querySelector('.out-7').textContent = Math.pow(i71, i72);
}
...
function f10(){
    ...
    document.querySelector('.out-10').textContent = sel;
}
...
function f11(){
    ...
    document.querySelector('.out-11').textContent = sel;
}
...
function f13(){
    let per = document.querySelector('.i-130').value;
    document.querySelector('.out-13').textContent = (typeof per);  
}
...
function f14(){
    let sel = document.querySelector('.s-143').value,
        i1 = +document.querySelector('.i-141').value,
        i2 = +document.querySelector('.i-142').value;
    switch (sel) {
        case '+': 
        document.querySelector('.out-14').textContent = i1 + i2;
        break;
        case '-': 
        document.querySelector('.out-14').textContent = i1 - i2;
        break;
...
function f15(){
    let s1 = +document.querySelector('.s-151').value,
        s2 = +document.querySelector('.s-152').value,
        s3 = document.querySelector('.s-153').value;
    if (s3 === '&&') {
        document.querySelector('.out-15').textContent = s1 && s2;
    } else {
        document.querySelector('.out-15').textContent = s1 || s2;
    }
}
