...
function f1() {
    document.querySelector('.out-1').style = "height: 40px; width: 200px";
}
...
function f5() {
    document.querySelector('.out-5').innerHTML = document.querySelector('.out-4').classList.contains('bg-4');
}
...
function f18() {
    ...
    document.querySelector('.out-18').innerHTML = p.getAttribute('data-b');
}
